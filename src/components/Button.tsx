...
export const buttonVariants = cva("p-4 transition-colors cursor-pointer", {
  variants: {
    variant: {
      default:
      ...
      ghost:
        "hover:bg-brand-150 max-[768px]:focus:bg-brand-150 dark:hover:bg-brand-850 max-[768px]:dark:focus:bg-brand-850",
      "ghost-secondary":
        "hover:bg-brand-200 max-[768px]:focus:bg-brand-200 dark:hover:bg-brand-800 max-[768px]:dark:focus:bg-brand-800",
      secondary:
        "bg-brand-300 dark:bg-brand-850 hover:bg-brand-200 max-[768px]:focus:bg-brand-200 dark:hover:bg-brand-800 max-[768px]:dark:focus:bg-brand-800",
    },
    size: {
  ...
  compoundVariants: [
    {
      selected: true,
      variant: "ghost",
      className: "bg-brand-150 dark:bg-brand-850",
    },
    {
      selected: true,
      variant: "ghost-secondary",
      className: "bg-brand-200 dark:bg-brand-700",
    },
    {
      selected: true,
      variant: "default",
      className:
        "bg-brand-800 dark:bg-brand-400 text-white dark:text-brand-900",
    },
    {
      selected: true,
      variant: "secondary",
