  ...
  return (
    <input
      ...
      className={cn(
        ...
        "text-brand-975 dark:text-brand-50 placeholder:text-brand-700 dark:placeholder:text-brand-600",
  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        "text-brand-975 dark:text-brand-50 placeholder:text-brand-700 dark:placeholder:text-brand-600",
        // Standard scrollbar styling (Firefox and modern browsers) - VISIBLE
        "scrollbar-thin",
        "scrollbar-thumb-brand-400 dark:scrollbar-thumb-brand-800",
        "hover:scrollbar-thumb-brand-400 dark:hover:scrollbar-thumb-brand-800", // Same color on hover
        "scrollbar-track-transparent",
        // Webkit scrollbar - INVISIBLE (Chrome, Safari, Edge)
