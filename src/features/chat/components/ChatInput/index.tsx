...
const ChatInputInner: React.FC<ChatInputProps> = ({
  ...
  return (
    <Box
      alignItems="end"
      justifyContent="end"
      className="w-full min-h-26.5 max-h-58.5 px-4 pb-4 h-auto shadow-[0px_-24px_18px_-4px_rgba(255,255,255,0.95)] dark:shadow-[0px_-24px_18px_-4px_rgba(20,20,20,0.95)]"
    >
